...
class OrderProcessingStation <T extends Enum<T>> {
  private static int stationNumberCounter = 1;
  private final int stationNumber;
  private final Restaurant <T> restaurant; // TODO remove this dependency.
  private final Colors color;
  private boolean isOpen;

  OrderProcessingStation(Restaurant <T> restaurant) {
